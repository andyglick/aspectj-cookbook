/**
 * <p>Title: AfterThrowingAdvice aspect for Recipe 10.7</p>
 * <p>Description: Simple aspect for demonstrating the use of after throwing advice.</p>
...
public aspect AfterThrowingAdviceRecipe 
{
   ...
   */
   ...
   after() throwing() : callPointCut()
      && !within(AfterThrowingAdviceRecipe +)
   {
      System.out.println(
         "------------------- Aspect Advice Logic --------------------");
      System.out.println(
